<div class="">
    <div class="bg-white dark:bg-gray-800 pt-4 rounded-lg shadow-md px-4 flex items-center justify-between">
       <div class="">
           ...
           <p class="text-xl mt-1 font-bold dark:text-white">$ {{ number_format($admin->wallet, 2) }}</p>
       </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 flex items-center justify-between">
       <div class="">
           ...
           <p class="text-xl mt-1 font-bold dark:text-white">$ {{ number_format($admin->receive_wallet, 2) }}</p>
       </div>
